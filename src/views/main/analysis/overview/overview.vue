<template>
  <div class="overview">
    ...
    <tl-card title="技术栈">
      <tl-text-link :text-arrs="technologyStacks" />
      <tl-descriptions
        title="生产环境依赖"
        :column="2"
    ...
    <tl-card title="项目结构">
      <div class="c-left">
        <tl-code language="bash" :code="projectDir" />
      </div>
    </tl-card>
    <tl-card title="项目规范">
      <tl-descriptions
...
import TlDescriptions from '@/base-ui/descriptions'
import TlTextLink from '@/base-ui/text-link'
import TlCode from '@/base-ui/code'
